...
def anneal_dsm_score_estimation(scorenet, x, labels=None, loss_type='a', hook=None, cond=None, cond_mask=None,
                                gamma=False, L1=False, all_frames=False, texts=None,deepth_video=None,motion = None):
    ...
    loss = pow_((z - scorenet(perturbed_x, labels, cond_mask=cond_mask,texts=texts,deepth_video=deepth_video,motion=motion)).reshape(len(x), -1)).sum(dim=-1)
